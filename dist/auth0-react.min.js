!(function (e, t) {
  ...
  var C = function (e) {
    ...
    R = function (e, t) {
      if (!x(e)) return e;
      var i, n;
      if (t && 'function' == typeof (i = e.toString) && !x((n = i.call(e))))
        return n;
    ...
    W = p.document,
    H = x(W) && x(W.createElement),
    w = function (e) {
      return H ? W.createElement(e) : {};
    },
    L =
      !m &&
      !h(function () {
    ...
    k = {
      f: m
        ...
        : function (e, t) {
            ...
            if (J(e, t)) return U(!Z.f.call(e, t), e[t]);
          },
    },
    N = function (e) {
      if (!x(e)) throw TypeError(String(e) + ' is not an object');
      return e;
    },
  ...
  var P,
    ...
    se = p.WeakMap;
  if ($) {
    var le = D.state || (D.state = new se()),
      ue = le.get,
      ae = le.has,
      Ie = le.set;
    (P = function (e, t) {
      return (t.facade = e), Ie.call(le, e, t), t;
    }),
      (j = function (e) {
        return ue.call(le, e) || {};
      }),
  ...
  var de,
    ...
    ye = B(function (e) {
      ...
      (e.exports = function (e, t, c, o) {
        var r,
          ...
          u = !!o && !!o.noTargetGet;
        'function' == typeof c &&
          ('string' != typeof t || J(c, 'name') || K(c, 'name', t),
          (r = i(c)).source ||
            (r.source = n.join('string' == typeof t ? t : ''))),
          e !== p
    ...
    pe = function (e, t) {
      return arguments.length < 2
        ? Ce(Be[e]) || Ce(p[e])
        : (Be[e] && Be[e][t]) || (p[e] && p[e][t]);
    },
    he = Math.ceil,
    me = Math.floor,
    fe = function (e) {
      return isNaN((e = +e)) ? 0 : (e > 0 ? me : he)(e);
    },
    Fe = Math.min,
    Ze = function (e) {
      return e > 0 ? Fe(fe(e), 9007199254740991) : 0;
    },
    Ue = Math.max,
    Ve = Math.min,
    Xe = function (e) {
    ...
    ve = function (e, t) {
      var i,
        ...
        c = 0,
        o = [];
      for (i in n) !J(re, i) && J(n, i) && o.push(i);
      for (; t.length > c; ) J(n, (i = t[c++])) && (~Se(o, i) || o.push(i));
      return o;
    },
    Qe = [
      'constructor',
    ...
    We = function (e, t) {
      for (var i = Je(t), n = T.f, c = k.f, o = 0; o < i.length; o++) {
        var r = i[o];
        J(e, r) || n(e, r, c(t, r));
      }
    },
    ...
    we = function (e, t) {
      var i = Ye[Le(e)];
      return i == Ne || (i != ke && ('function' == typeof t ? h(t) : !!t));
    },
    Le = (we.normalize = function (e) {
    ...
    Ke = function (e, t) {
      var i,
        ...
        l = e.global,
        u = e.stat;
      if ((i = l ? p : u ? p[s] || z(s, {}) : (p[s] || {}).prototype))
        for (n in t) {
          if (
            ((o = t[n]),
            (c = e.noTargetGet ? (r = Te(i, n)) && r.value : i[n]),
            !Ee(l ? n : s + (u ? '.' : '#') + n, e.forced) && void 0 !== c)
          ) {
            if (typeof o == typeof c) continue;
            We(o, c);
          }
          (e.sham || (c && c.sham)) && K(o, 'sham', !0), ye(i, n, o, e);
        }
    },
    ze =
    ...
    De = ze && !Symbol.sham && 'symbol' == typeof Symbol.iterator,
    Oe = ee('wks'),
    Pe = p.Symbol,
    je = De ? Pe : (Pe && Pe.withoutSetter) || ne,
    Me = function (e) {
      return (
        J(Oe, e) ||
          (ze && J(Pe, e) ? (Oe[e] = Pe[e]) : (Oe[e] = je('Symbol.' + e))),
        Oe[e]
      );
    },
    _e = Me('match'),
    qe = function (e) {
      if (
        (function (e) {
          var t;
          return x(e) && (void 0 !== (t = e[_e]) ? !!t : 'RegExp' == X(e));
        })(e)
      )
    ...
    ct = et('startsWith'),
    ot = !(
      ct || ((de = tt(String.prototype, 'startsWith')), !de || de.writable)
    );
  Ke(
    { target: 'String', proto: !0, forced: !ot && !ct },
    {
      startsWith: function (e) {
        var t = String(v(this));
        qe(e);
        var i = Ze(nt(arguments.length > 1 ? arguments[1] : void 0, t.length)),
          n = String(e);
  ...
  var rt,
    ...
    at = Function.call,
    It = function (e, t, i) {
      return ut(at, p[e].prototype[t], i);
    },
    gt =
    ...
    Bt = function (e, t) {
      ...
      return (
        gt(e) &&
          ...
          (i !== Array && !gt(i.prototype))
            ? x(i) && null === (i = i[yt]) && (i = void 0)
            : (i = void 0)),
        new (void 0 === i ? Array : i)(0 === t ? 0 : t)
      );
    },
    Ct = pe('navigator', 'userAgent') || '',
    pt = p.process,
    ht = pt && pt.versions,
    mt = ht && ht.v8;
  mt
    ? (st = (rt = mt.split('.'))[0] + rt[1])
    : Ct &&
  ...
  var ft = st && +st,
    ...
    Xt = function (e) {
      if (!x(e)) return !1;
      var t = e[Zt];
      return void 0 !== t ? !!t : gt(e);
    };
  Ke(
    { target: 'Array', proto: !0, forced: !Ut || !Vt },
    {
      concat: function (e) {
        var t,
          i,
        ...
        for (t = -1, n = arguments.length; t < n; t++)
          if (Xt((o = -1 === t ? r : arguments[t]))) {
            if (l + (c = Ze(o.length)) > 9007199254740991)
              throw TypeError('Maximum allowed index exceeded');
            for (i = 0; i < c; i++, l++) i in o && bt(s, l, o[i]);
          } else {
  ...
  St || ye(Object.prototype, 'toString', Rt, { unsafe: !0 });
  var At,
    Jt =
      Object.keys ||
      function (e) {
    ...
    Wt = m
      ...
      : function (e, t) {
          N(e);
          for (var i, n = Jt(t), c = n.length, o = 0; c > o; )
            T.f(e, (i = n[o++]), t[i]);
          return e;
        },
    Ht = pe('document', 'documentElement'),
    wt = oe('IE_PROTO'),
    Lt = function () {},
    Yt = function (e) {
    ...
    kt = function () {
      ...
      kt = At
        ...
        : (((t = w('iframe')).style.display = 'none'),
          ...
          e.write(Yt('document.F=Object')),
          e.close(),
          e.F);
      for (var i = Qe.length; i--; ) delete kt.prototype[Qe[i]];
      return kt();
    };
  re[wt] = !0;
  var Nt =
    ...
    zt = {
      f: function (e) {
        return Kt && '[object Window]' == Tt.call(e)
          ? (function (e) {
              try {
                return Et(e);
              } catch (e) {
    ...
    Pt = function (e) {
      ...
      J(t, e) || Ot(t, e, { value: Dt.f(e) });
    },
    jt = T.f,
    Mt = Me('toStringTag'),
    _t = function (e, t, i) {
      e &&
        !J((e = i ? e : e.prototype), Mt) &&
        jt(e, Mt, { configurable: !0, value: t });
    },
    qt = [].push,
    $t = function (e) {
      var t = 1 == e,
      ...
      return function (l, u, a, I) {
        for (
          var g,
            ...
            p = 0,
            h = I || Bt,
            m = t ? h(l, C) : i || r ? h(l, 0) : void 0;
          C > p;
          p++
        )
          if ((s || p in y) && ((d = B((g = y[p]), p, b)), e))
            if (t) m[p] = d;
            else if (d)
              switch (e) {
                case 3:
    ...
    ei = [$t(0), $t(1), $t(2), $t(3), $t(4), $t(5), $t(6), $t(7)][0],
    ti = oe('hidden'),
    ii = Me('toPrimitive'),
    ni = be.set,
    ci = be.getterFor('Symbol'),
    oi = Object.prototype,
    ri = p.Symbol,
    si = pe('JSON', 'stringify'),
    li = k.f,
    ui = T.f,
    ai = zt.f,
    Ii = Z.f,
    gi = ee('symbols'),
    di = ee('op-symbols'),
    bi = ee('string-to-symbol-registry'),
    yi = ee('symbol-to-string-registry'),
    Bi = ee('wks'),
    Ci = p.QObject,
    pi = !Ci || !Ci.prototype || !Ci.prototype.findChild,
    hi =
      m &&
      h(function () {
        return (
        ...
        ? function (e, t, i) {
            var n = li(oi, t);
            n && delete oi[t], ui(e, t, i), n && e !== oi && ui(oi, t, n);
          }
        : ui,
    mi = function (e, t) {
      var i = (gi[e] = Nt(ri.prototype));
      return (
        ni(i, { type: 'Symbol', tag: e, description: t }),
        m || (i.description = t),
        i
      );
    },
    ...
    Fi = function (e, t, i) {
      ...
      return (
        ...
        J(gi, n)
          ? (i.enumerable
              ? (J(e, ti) && e[ti][n] && (e[ti][n] = !1),
                (i = Nt(i, { enumerable: U(0, !1) })))
              : (J(e, ti) || ui(e, ti, U(1, {})), (e[ti][n] = !0)),
            hi(e, n, i))
          : ui(e, n, i)
      );
    },
    ...
    Ui = function (e) {
      var t = R(e, !0),
        i = Ii.call(this, t);
      return (
        !(this === oi && J(gi, t) && !J(di, t)) &&
        (!(i || !J(this, t) || !J(gi, t) || (J(this, ti) && this[ti][t])) || i)
      );
    },
    Vi = function (e, t) {
      var i = Q(e),
      ...
      if (i !== oi || !J(gi, n) || J(di, n)) {
        var c = li(i, n);
        return (
          !c || !J(gi, n) || (J(i, ti) && i[ti][n]) || (c.enumerable = !0), c
        );
      }
    },
    Xi = function (e) {
  ...
  if (
    (ze ||
      (ye(
        (ri = function () {
          ...
          var e =
            ...
            i = function (e) {
              this === oi && i.call(di, e),
                J(this, ti) && J(this[ti], t) && (this[ti][t] = !1),
                hi(this, t, U(1, e));
            };
          return m && pi && hi(oi, t, { configurable: !0, set: i }), mi(t, e);
        }).prototype,
        'toString',
        function () {
          return ci(this).tag;
      ...
      ye(ri, 'withoutSetter', function (e) {
        return mi(ne(e), e);
      }),
      (Z.f = Ui),
      (T.f = Fi),
      ...
      m &&
        ...
        ye(oi, 'propertyIsEnumerable', Ui, { unsafe: !0 }))),
    Ke({ global: !0, wrap: !0, forced: !ze, sham: !ze }, { Symbol: ri }),
    ei(Jt(Bi), function (e) {
      Pt(e);
    }),
    Ke(
      { target: 'Symbol', stat: !0, forced: !ze },
      {
        for: function (e) {
          var t = String(e);
          if (J(bi, t)) return bi[t];
          var i = ri(t);
          return (bi[t] = i), (yi[i] = t), i;
        },
        keyFor: function (e) {
          if (!fi(e)) throw TypeError(e + ' is not a symbol');
          if (J(yi, e)) return yi[e];
        },
        useSetter: function () {
          pi = !0;
        },
    ...
    Ke(
      { target: 'Object', stat: !0, forced: !ze, sham: !m },
      {
        create: function (e, t) {
          return void 0 === t ? Nt(e) : Zi(Nt(e), t);
        },
        defineProperty: Fi,
        defineProperties: Zi,
    ...
    Ke(
      { target: 'JSON', stat: !0, forced: Si },
      {
        stringify: function (e, t, i) {
          for (var n, c = [e], o = 1; arguments.length > o; )
            c.push(arguments[o++]);
          if (((n = t), (x(t) || void 0 !== e) && !fi(e)))
            return (
              gt(t) ||
                (t = function (e, t) {
                  if (
                    ('function' == typeof n && (t = n.call(this, e, t)), !fi(t))
                  )
                    return t;
                }),
              (c[1] = t),
      ...
      Ri = function () {
        var e =
            arguments.length < 1 || void 0 === arguments[0]
              ? void 0
              : String(arguments[0]),
          t = this instanceof Ri ? new Qi(e) : void 0 === e ? Qi() : Qi(e);
        return '' === e && (xi[t] = !0), t;
      };
    We(Ri, Qi);
    var Ai = (Ri.prototype = Qi.prototype);
    Ai.constructor = Ri;
    var Ji = Ai.toString,
      Wi = 'Symbol(test)' == String(Qi('test')),
      Hi = /^Symbol\((.*)\)[^)]+$/;
    vi(Ai, 'description', {
      configurable: !0,
      get: function () {
        var e = x(this) ? this.valueOf() : this,
          t = Ji.call(e);
        if (J(xi, e)) return '';
        var i = Wi ? t.slice(7, -1) : t.replace(Hi, '$1');
        return '' === i ? void 0 : i;
      },
    }),
      Ke({ global: !0, forced: !0 }, { Symbol: Ri });
  }
  Pt('hasInstance'),
    Pt('isConcatSpreadable'),
    Pt('iterator'),
    Pt('match'),
    Pt('matchAll'),
    Pt('replace'),
  ...
  var Pi = { IteratorPrototype: wi, BUGGY_SAFARI_ITERATORS: Oi },
    ...
    en = Pi.BUGGY_SAFARI_ITERATORS,
    tn = Me('iterator'),
    nn = function () {
      return this;
    },
    cn = function (e, t, i, n, c, o, r) {
      !(function (e, t, i) {
        var n = t + ' Iterator';
        (e.prototype = Nt(Mi, { next: U(1, i) })), _t(e, n, !1), (ji[n] = _i);
      })(i, t, n);
      var s,
        l,
        u,
        ...
        g = !1,
        d = e.prototype,
        b = d[tn] || d['@@iterator'] || (c && d[c]),
        y = (!en && b) || a(c),
        B = ('Array' == t && d.entries) || b;
      if (
        (B &&
          ((s = zi(B.call(new e()))),
          $i !== Object.prototype &&
            s.next &&
            (zi(s) !== $i &&
              (qi ? qi(s, $i) : 'function' != typeof s[tn] && K(s, tn, nn)),
            _t(s, I, !0))),
        'values' == c &&
          b &&
          'values' !== b.name &&
        ...
        if (
          ...
          for (u in l) (en || g || !(u in d)) && ye(d, u, l[u]);
        else Ke({ target: t, proto: !0, forced: en || g }, l);
      return l;
    },
    on = Ni.charAt,
    rn = be.set,
    sn = be.getterFor('String Iterator');
  cn(
    String,
    'String',
    function (e) {
      rn(this, { type: 'String Iterator', string: String(e), index: 0 });
    },
    function () {
      var e,
        t = sn(this),
      ...
      return n >= i.length
        ? { value: void 0, done: !0 }
        : ((e = on(i, n)), (t.index += e.length), { value: e, done: !1 });
    }
  );
  var ln = function (e) {
      var t = e.return;
    ...
    In = Array.prototype,
    gn = function (e) {
      return void 0 !== e && (ji.Array === e || In[an] === e);
    },
    dn = Me('iterator'),
    bn = function (e) {
      if (null != e) return e[dn] || e['@@iterator'] || ji[xt(e)];
    },
    yn = Me('iterator'),
    Bn = !1;
  try {
    ...
    { target: 'Array', stat: !0, forced: mn },
    {
      from: function (e) {
        var t,
          ...
          d = 0;
        if (
          (I && (a = ut(a, u > 2 ? arguments[2] : void 0, 2)),
          null == g || (l == Array && gn(g)))
        )
          for (i = new l((t = Ze(s.length))); t > d; d++)
            (r = I ? a(s[d], d) : s[d]), bt(i, d, r);
        else
          for (
            ...
            (r = I ? un(c, a, [n.value, d], !0) : n.value), bt(i, d, r);
        return (i.length = d), i;
      },
    }
  ),
  ...
  var fn,
    ...
    xn = Qn.isPrototypeOf,
    Rn = Me('toStringTag'),
    An = ne('TYPED_ARRAY_TAG'),
    Jn = Fn && !!qi && 'Opera' !== xt(p.opera),
    Wn = {
      Int8Array: 1,
      Uint8Array: 1,
      Uint8ClampedArray: 1,
  ...
  if (
    ...
    for (fn in Wn) p[fn] && qi(p[fn], Sn);
  if ((!Jn || !vn || vn === Qn) && ((vn = Sn.prototype), Jn))
    for (fn in Wn) p[fn] && qi(p[fn].prototype, vn);
  if ((Jn && zi(Gn) !== vn && qi(Gn, vn), m && !J(vn, Rn)))
    for (fn in (Zn(vn, Rn, {
      get: function () {
        return x(this) ? this[An] : void 0;
      },
    }),
    Wn))
      p[fn] && K(p[fn], An, fn);
  var Hn = Me('species'),
    ...
    Ln = function (e) {
      if (qi) {
        if (xn.call(Sn, e)) return e;
      } else
        for (var t in Wn)
          if (J(Wn, fn)) {
            var i = p[t];
            if (i && (e === i || xn.call(i, e))) return e;
          }
  ...
  !(function (e, t, i) {
    if (m) {
      if (i)
        for (var n in Wn) {
          var c = p[n];
          c && J(c.prototype, e) && delete c.prototype[e];
        }
      (vn[e] && !i) || ye(vn, e, i ? t : (Jn && Vn[e]) || t);
    }
  })(
    'slice',
    function (e, t) {
      for (
        var i = Yn.call(wn(this), e, t),
          n = (function (e, t) {
            var i,
              n = N(e).constructor;
            return void 0 === n || null == (i = N(n)[Hn]) ? t : lt(i);
  ...
  var kn = Me('unscopables'),
    Nn = Array.prototype;
  null == Nn[kn] && T.f(Nn, kn, { configurable: !0, value: Nt(null) });
  var En = function (e) {
      Nn[kn][e] = !0;
    },
    ...
    Dn = Ge.includes,
    On = (function (e, t) {
      if (J(Kn, e)) return Kn[e];
      t || (t = {});
      var i = [][e],
        n = !!J(t, 'ACCESSORS') && t.ACCESSORS,
        c = J(t, 0) ? t[0] : zn,
        o = J(t, 1) ? t[1] : void 0;
      return (Kn[e] =
        !!i &&
        !h(function () {
          if (n && !m) return !0;
          var e = { length: -1 };
          n ? Tn(e, 1, { enumerable: !0, get: zn }) : (e[1] = 1),
            i.call(e, c, o);
        }));
  ...
  var Pn = !h(function () {
    ...
    jn = B(function (e) {
      var t = T.f,
        ...
        r = (e.exports = {
          ...
          onFreeze: function (e) {
            return Pn && r.REQUIRED && c(e) && !J(e, i) && o(e), e;
          },
        });
      re[i] = !0;
    }),
    ...
    _n = function (e, t, i) {
      var n,
        ...
        b = ut(t, a, 1 + I + d),
        y = function (e) {
          return n && ln(n), new Mn(!0, e);
        },
        B = function (e) {
          return I
            ? (N(e), d ? b(e[0], e[1], y) : b(e[0], e[1]))
            : d
            ? b(e, y)
            : b(e);
        };
      if (g) n = e;
        ...
        if ('function' != typeof (c = bn(e)))
          throw TypeError('Target is not iterable');
        if (gn(c)) {
          for (o = 0, r = Ze(e.length); r > o; o++)
            if ((s = B(e[o])) && s instanceof Mn) return s;
          return new Mn(!1);
        }
        n = c.call(e);
      }
      for (l = n.next; !(u = l.call(n)).done; ) {
        ...
        if ('object' == typeof s && s && s instanceof Mn) return s;
      }
      return new Mn(!1);
    },
    qn = function (e, t, i) {
    ...
    oc =
      ((function (e, t, i) {
          ...
          a = function (e) {
            ...
            ye(
              ...
              'add' == e
                ...
                : 'delete' == e
                ? function (e) {
                    return !(c && !x(e)) && t.call(this, 0 === e ? 0 : e);
                  }
                : 'get' == e
                ? function (e) {
                    return c && !x(e) ? void 0 : t.call(this, 0 === e ? 0 : e);
                  }
                : 'has' == e
                ? function (e) {
                    return !(c && !x(e)) && t.call(this, 0 === e ? 0 : e);
        ...
        if (
          ...
          (l = i.getConstructor(t, e, n, o)), (jn.REQUIRED = !0);
        else if (Ee(e, !0)) {
          var I = new l(),
            g = I[o](c ? {} : -0, 1) != I,
            d = h(function () {
          ...
          getConstructor: function (e, t, i, n) {
            var c = e(function (e, o) {
                qn(e, c, t),
                  ...
                  m || (e.size = 0),
                  null != o && _n(o, e[n], { that: e, AS_ENTRIES: i });
              }),
              o = cc(t),
              r = function (e, t, i) {
                var n,
    ...
    rc = be.set,
    sc = be.getterFor('Array Iterator'),
    lc = cn(
      Array,
      'Array',
      function (e, t) {
        rc(this, { type: 'Array Iterator', target: Q(e), index: 0, kind: t });
      },
      function () {
        var e = sc(this),
          t = e.target,
  ...
  (ji.Arguments = ji.Array), En('keys'), En('values'), En('entries');
  var uc = Me('iterator'),
    ac = Me('toStringTag'),
    Ic = lc.values;
  for (var gc in oc) {
        ...
        if (i && ('object' == typeof i || 'function' == typeof i)) {
          ...
          if ('function' == typeof r)
            return void r.call(
              ...
              function (i) {
                (n[e] = { status: 'rejected', reason: i }), 0 == --c && t(n);
              }
            );
        }
        (n[e] = { status: 'fulfilled', value: i }), 0 == --c && t(n);
      }
        ...
        fc._immediateFn(function () {
          ...
          if (null !== i) {
            ...
            try {
              ...
              return void Uc(t.promise, e);
            }
            Zc(t.promise, n);
          } else (1 === e._state ? Zc : Uc)(t.promise, e._value);
        }))
      : e._deferreds.push(t);
  }
  function Zc(e, t) {
    try {
      ...
      if (t && ('object' == typeof t || 'function' == typeof t)) {
        var i = t.then;
        if (t instanceof fc) return (e._state = 3), (e._value = t), void Vc(e);
  ...
  function Uc(e, t) {
    (e._state = 2), (e._value = t), Vc(e);
  }
  function Vc(e) {
    2 === e._state &&
      0 === e._deferreds.length &&
      fc._immediateFn(function () {
        e._handled || fc._unhandledRejectionFn(e._value);
      });
    for (var t = 0, i = e._deferreds.length; t < i; t++) Fc(e, e._deferreds[t]);
    e._deferreds = null;
  }
  function Xc(e, t, i) {
  ...
  (fc.prototype.catch = function (e) {
    return this.then(null, e);
  }),
    (fc.prototype.then = function (e, t) {
      var i = new this.constructor(mc);
      return Fc(this, new Xc(e, t, i)), i;
    }),
    (fc.prototype.finally = Bc),
    (fc.all = function (e) {
      return new fc(function (t, i) {
        if (!hc(e)) return i(new TypeError('Promise.all accepts an array'));
        var n = Array.prototype.slice.call(e);
        if (0 === n.length) return t([]);
        var c = n.length;
        function o(e, r) {
    ...
    (fc.allSettled = Cc),
    (fc.resolve = function (e) {
      return e && 'object' == typeof e && e.constructor === fc
        ? e
        : new fc(function (t) {
            t(e);
          });
    }),
    (fc.reject = function (e) {
      return new fc(function (t, i) {
        i(e);
      });
    }),
    (fc.race = function (e) {
      return new fc(function (t, i) {
        if (!hc(e)) return i(new TypeError('Promise.race accepts an array'));
        for (var n = 0, c = e.length; n < c; n++) fc.resolve(e[n]).then(t, i);
      });
    }),
    (fc._immediateFn =
    ...
    (fc._unhandledRejectionFn = function (e) {
  ...
  'function' != typeof Sc.Promise
    ...
    ? Sc.Promise.allSettled || (Sc.Promise.allSettled = Cc)
              ...
              },
              {
                ...
                value: function (e) {
                  'abort' === e.type &&
                    ...
                    u(c(l.prototype), 'dispatchEvent', this).call(this, e);
                },
              },
            ]),
            l
          ...
          (function (e) {
            return e.__FORCE_INSTALL_ABORTCONTROLLER_POLYFILL
              ...
              : ('function' == typeof e.Request &&
                  ...
                  !e.AbortController;
          })(e) && ((e.AbortController = g), (e.AbortSignal = I));
        })('undefined' != typeof self ? self : b);
    })();
  var vc = B(function (e, t) {
  ...
  var Qc = y(
      B(function (e, t) {
        ...
        var s = (function () {
          ...
          return (
            (e.prototype.acquireLock = function (t, s) {
              return (
                void 0 === s && (s = 5e3),
                ...
                if (s.includes(c)) {
                  ...
                  null !== l &&
                    ((void 0 === (l = JSON.parse(l)).timeRefreshed &&
                      l.timeAcquired < t) ||
                      (void 0 !== l.timeRefreshed && l.timeRefreshed < t)) &&
                    (i.removeItem(s), (o = !0));
                }
              }
              o && e.notifyWaiters();
    ...
    Ac = { name: 'auth0-spa-js', version: '1.13.6' },
    Jc = (function (e) {
      function t(i, n) {
            ...
            if (
              ...
              i && i.close(),
                e.data.response.error
                  ? c(Jc.fromPayload(e.data.response))
                  : n(e.data.response),
                clearTimeout(l),
                window.removeEventListener('message', r, !1),
                setTimeout(s, 2e3);
        ...
        (n = function (t) {
          if (t.data && 'authorization_response' === t.data.type) {
            if (
              ...
              return i(Jc.fromPayload(t.data.response));
            e(t.data.response);
          }
        }),
    ...
    Mc = function (e, t, i, n, c, o) {
      return g(void 0, void 0, void 0, function () {
        return d(this, function (r) {
          return [
            2,
            ((s = {
              auth: { audience: t, scope: i },
              timeout: c,
              fetchUrl: e,
              fetchOptions: n,
            }),
    ...
    _c = function (e, t, i, n, c, o) {
      return (
        void 0 === o && (o = 1e4),
        g(void 0, void 0, void 0, function () {
          return d(this, function (r) {
            return c ? [2, Mc(e, t, i, n, o, c)] : [2, jc(e, n, o)];
          });
        })
      );
    };
  function qc(e, t, i, n, c, o) {
      ...
      return d(this, function (d) {
        switch (d.label) {
          ...
          case 1:
            ...
            d.label = 2;
          case 2:
            return d.trys.push([2, 4, , 5]), [4, _c(e, i, n, c, o, t)];
          case 3:
          ...
          case 6:
            ...
            if (
              ...
              throw new Jc(
                g || 'request_error',
                b || 'HTTP error. Unable to fetch ' + e
              );
            return [2, y];
        }
      });
  ...
  var $c = function (e) {
    ...
    eo = function () {
      ...
      return $c(e.join(' ').trim().split(/\s+/)).join(' ');
    };
  function to(e, t) {
    var i = e.baseUrl,
      n = e.timeout,
      ...
      o = e.scope,
      r = e.auth0Client,
      s = I(e, ['baseUrl', 'timeout', 'audience', 'scope', 'auth0Client']);
    return g(this, void 0, void 0, function () {
      var e, l;
      ...
      return (
        ...
        (e.fromKey = function (t) {
          var i = t.split('::'),
            ...
            r = i[3];
          return (
            console.log('CaheKey:', c, r, o),
            new e({ client_id: c, scope: r, audience: o }, n)
          );
        }),
        e
      );
      ...
      return (
        (e.prototype.save = function (e) {
          var t = new io({
            ...
            i = co(e);
          window.localStorage.setItem(t.toKey(), JSON.stringify(i));
        }),
        (e.prototype.get = function (e, t) {
          void 0 === t && (t = 0);
          var i = this.readJson(e),
            n = Math.floor(Date.now() / 1e3);
          if (i) {
            if (!(i.expiresAt - t < n)) return i.body;
            if (i.body.refresh_token) {
              var c = this.stripData(i);
              return this.writeJson(e.toKey(), c), c.body;
            }
  ...
  y(Io), Io.encode, Io.parse, Io.getAll, Io.get, Io.set, Io.remove;
  var go = {
      get: function (e) {
  ...
  var yo,
    ...
    fo = (function () {
      function e(e) {
        ...
        var n,
          c,
          o = e.useCookiesForTransactions ? this.cookieStorage : go;
        (this.cache = mo(this.cacheLocation)()),
          (this.scope = this.options.scope),
          (this.transactionManager = new lo(o)),
      ...
      return (
        ...
        (e.prototype._getParams = function (e, t, i, n, c) {
          ...
          return a(a(a({}, r), e), {
            scope: eo(this.defaultScope, this.scope, e.scope),
            response_type: 'code',
            response_mode: 'query',
            state: t,
            nonce: i,
        ...
        (e.prototype._authorizeUrl = function (e) {
          return this._url('/authorize?' + Kc(e));
        }),
        (e.prototype._verifyIdToken = function (e, t, i) {
          return (function (e) {
            if (!e.id_token)
            ...
            if (e.max_age && !uo(t.claims.auth_time))
              throw new Error(
                ...
                switch (d.label) {
                  ...
                  case 1:
                    return (
                      ...
                      console.log('buildAuthorizeUrl: url + fragment', b, u),
                      [2, b + u]
                    );
                }
              });
            ...
            g(this, void 0, void 0, function () {
              ...
              return d(this, function (c) {
                return (
                  ...
                  (i = eo(this.defaultScope, this.scope, e.scope)),
                  (n = this.cache.get(
                    new io({
                      client_id: this.options.client_id,
                      audience: t,
                  ...
                  console.log('getUser :', t, i, n, this.options.client_id),
                  [2, n && n.decodedToken && n.decodedToken.user]
                );
              });
            })
          );
        ...
        (e.prototype.handleRedirectCallback = function (e) {
          return (
            ...
            g(this, void 0, void 0, function () {
              var t, i, n, c, o, r, s, l, u, I, g;
              return d(this, function (d) {
                switch ((console.log('handleRedirectCallBack1'), d.label)) {
                  case 0:
                    if (
                      ((t = e.split('?').slice(1)),
                  ...
                  case 1:
                    return (
                      ...
                      console.log('transcation.appSate = ', s.appState),
            ...
            return d(this, function (i) {
              switch (i.label) {
                ...
                case 2:
                  return i.sent(), [3, 4];
                case 3:
                  if (((t = i.sent()), !Rc.includes(t.error))) throw t;
                  return [3, 4];
                case 4:
                  return [2];
              }
          ...
          return (
            ...
            g(this, void 0, void 0, function () {
              ...
              return d(this, function (o) {
                return (
                  (t = a(
                    a({ audience: this.options.audience, ignoreCache: !1 }, e),
                    { scope: eo(this.defaultScope, this.scope, e.scope) }
                  )),
                  (i = t.ignoreCache),
                  (n = I(t, ['ignoreCache'])),
            ...
            g(this, void 0, void 0, function () {
              ...
              return d(this, function (l) {
                switch (l.label) {
                  ...
                  case 7:
                    return [4, po.releaseLock('auth0.lock.getTokenSilently')];
                  case 8:
                    return l.sent(), [7];
                  case 9:
                    return [3, 11];
                ...
                switch (i.label) {
                  case 0:
                    return (
                      ...
                      (e.scope = eo(this.defaultScope, this.scope, e.scope)),
                      (t = a(a({}, xc), t)),
        ...
        (e.prototype._getTokenFromIFrame = function (e) {
          return g(this, void 0, void 0, function () {
            var t, i, n, c, o, r, s, l, u, g, b, y, B, C, p;
            return d(this, function (d) {
              switch (d.label) {
                case 0:
                  return (t = Tc(Ec())), (i = Tc(Ec())), (n = Ec()), [4, zc(n)];
                case 1:
                  (c = d.sent()),
                    (o = Oc(c)),
                    (r = this._getParams(
                ...
                case 4:
                  return (
                    (B = d.sent()),
                    (C = this._verifyIdToken(B.id_token, i)),
                    [
                      2,
                      a(a({}, B), {
                        decodedToken: C,
    ...
    Fo = { isAuthenticated: !1, isLoading: !0 },
    Zo = function () {
      throw new Error('You forgot to wrap your component in <Auth0Provider>.');
    },
    Uo = c(c({}, Fo), {
      buildAuthorizeUrl: Zo,
      buildLogoutUrl: Zo,
      getAccessTokenSilently: Zo,
      getAccessTokenWithPopup: Zo,
      getIdTokenClaims: Zo,
      loginWithRedirect: Zo,
      originalCallBack2: Zo,
      loginWithPopup: Zo,
      logout: Zo,
      handleRedirectCallback: Zo,
    }),
    Vo = t.createContext(Uo),
    Xo = (function (e) {
      function t(t, i) {
    ...
    Ro = xo('Login failed'),
    Ao = xo('Get access token failed'),
    Jo = function (e, t) {
      var i, n;
      switch ((console.log('reducer state = ', e, 'action = ', t), t.type)) {
        case 'LOGIN_POPUP_STARTED':
          return c(c({}, e), { isLoading: !0 });
        case 'LOGIN_POPUP_COMPLETE':
        case 'INITIALISED':
          return (
            console.log('reducer action = ', !!t.user, t),
            c(c({}, e), {
        ...
        case 'GET_ACCESS_TOKEN_COMPLETE':
          return (null === (i = e.user) || void 0 === i
            ? void 0
            : i.updated_at) ===
            (null === (n = t.user) || void 0 === n ? void 0 : n.updated_at)
            ? e
            : c(c({}, e), { isAuthenticated: !!t.user, user: t.user });
        case 'LOGOUT':
  ...
  (e.Auth0Context = Vo),
    (e.Auth0Provider = function (e) {
          ...
          return new fo(
            (function (e) {
              ...
              return c(c({}, r), {
                ...
                redirect_uri: i,
                max_age: n,
                auth0Client: { name: 'auth0-react', version: '1.5.0' },
              });
            })(I)
          );
        })[0],
        d = t.useReducer(Jo, Fo),
        b = d[0],
        y = d[1];
      console.log('Auth0Provider', g, b),
        t.useEffect(
          function () {
                ...
                switch (n.label) {
                  case 0:
                    return (
                      ...
                      !Qo() || l ? [3, 2] : [4, g.handleRedirectCallback()]
                    );
                  case 1:
                    return (
                      (e = n.sent().appState),
                      a(e),
                      console.log(a(e), 'appState = ', e),
                      [3, 4]
                    );
                  case 2:
                  ...
                  case 6:
                    return (
                      (i = n.sent()), y({ type: 'ERROR', error: Ro(i) }), [3, 7]
                    );
                  case 7:
                    return [2];
                }
      ...
      var B = t.useCallback(
          function (e) {
            return g.buildAuthorizeUrl(Wo(e));
          },
          [g]
        ),
        C = t.useCallback(
          function (e) {
            return g.buildLogoutUrl(e);
          },
          [g]
        ),
        p = t.useCallback(
          function (e) {
            return g.loginWithRedirect(Wo(e));
          },
          [g]
        ),
        h = t.useCallback(
              ...
              return s(this, function (c) {
                switch (c.label) {
                  ...
                  case 3:
                    return (
                      (i = y),
                      (n = { type: 'HANDLE_REDIRECT_COMPLETE' }),
                      [4, g.getUser()]
                    );
                  case 4:
                    return i.apply(void 0, [((n.user = c.sent()), n)]), [7];
                  case 5:
                    return [2];
                }
              });
            ...
            return r(void 0, void 0, void 0, function () {
              ...
              return s(this, function (c) {
                switch (c.label) {
                  ...
                  case 1:
                    return (
                      c.trys.push([1, 3, , 4]), [4, g.loginWithPopup(e, t)]
                    );
                  case 2:
                    return c.sent(), [3, 4];
                  case 3:
                    return (
                      (i = c.sent()), y({ type: 'ERROR', error: Ro(i) }), [2]
                    );
                  case 4:
                    return [4, g.getUser()];
                  case 5:
            ...
            return r(void 0, void 0, void 0, function () {
              ...
              return s(this, function (o) {
                switch (o.label) {
                  case 0:
                    return (
                      o.trys.push([0, 2, 3, 5]), [4, g.getTokenSilently(e)]
                    );
                  case 1:
                    return (t = o.sent()), [3, 5];
                  case 2:
                  ...
                  case 3:
                    return (
                      (n = y),
                      (c = { type: 'GET_ACCESS_TOKEN_COMPLETE' }),
                      [4, g.getUser()]
                    );
                  case 4:
                    return n.apply(void 0, [((c.user = o.sent()), c)]), [7];
                  case 5:
                    return [2, t];
                }
              });
            ...
            return r(void 0, void 0, void 0, function () {
              ...
              return s(this, function (r) {
                switch (r.label) {
                  case 0:
                    return (
                      r.trys.push([0, 2, 3, 5]), [4, g.getTokenWithPopup(e, t)]
                    );
                  case 1:
                    return (i = r.sent()), [3, 5];
                  case 2:
                  ...
                  case 4:
                    return c.apply(void 0, [((o.user = r.sent()), o)]), [7];
                  case 5:
                    return [2, i];
                }
              });
    ...
    (e.withAuth0 = function (e) {
      return function (t) {
        return i.createElement(Vo.Consumer, null, function (n) {

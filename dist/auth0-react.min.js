!(function (t, e) {
    ...
    k = {
      f: m
        ...
        : function (t, e) {
            ...
            if (J(t, e)) return U(!Z.f.call(t, e), t[e]);
          },
    },
    N = function (t) {
  ...
  var dt,
    ...
    mt = Math.floor,
    ft = function (t) {
      return isNaN((t = +t)) ? 0 : (t > 0 ? mt : ht)(t);
    },
    Ft = Math.min,
    Zt = function (t) {
    ...
    Wt = function (t, e) {
      for (var i = Jt(e), n = T.f, c = k.f, o = 0; o < i.length; o++) {
        var r = i[o];
        J(t, r) || n(t, r, c(e, r));
      }
    },
    ...
    wt = function (t, e) {
      var i = Yt[Lt(t)];
      return i == Nt || (i != kt && ('function' == typeof e ? h(e) : !!e));
    },
      ...
      if ((i = l ? p : u ? p[s] || z(s, {}) : (p[s] || {}).prototype))
        for (n in e) {
          if (
            ...
            !Et(l ? n : s + (u ? '.' : '#') + n, t.forced) && void 0 !== c)
          ) {
    ...
    Ot = tt('wks'),
    Pt = p.Symbol,
    jt = Dt ? Pt : (Pt && Pt.withoutSetter) || nt,
    Mt = function (t) {
      return (
        J(Ot, t) ||
          (zt && J(Pt, t) ? (Ot[t] = Pt[t]) : (Ot[t] = jt('Symbol.' + t))),
        Ot[t]
      );
    },
    _t = Mt('match'),
  ...
  var re,
    ...
    Ce = pt('navigator', 'userAgent') || '',
    pe = p.process,
    he = pe && pe.versions,
    me = he && he.v8;
  me
    ? (se = (re = me.split('.'))[0] + re[1])
    : Ce &&
  ...
  Kt(
    { target: 'Array', proto: !0, forced: !Ue || !Ve },
    {
      concat: function (t) {
        var e,
          i,
  ...
  var Ae,
    ...
    He = pt('document', 'documentElement'),
    we = ot('IE_PROTO'),
    Le = function () {},
    Ye = function (t) {
    ...
    ke = function () {
      ...
      ke = Ae
        ...
        : (((e = w('iframe')).style.display = 'none'),
          ...
          t.close(),
          t.F);
      for (var i = Qt.length; i--; ) delete ke.prototype[Qt[i]];
      return ke();
    };
  rt[we] = !0;
  var Ne =
  ...
  if (
    (zt ||
      (yt(
        (ri = function () {
          ...
          return m && pi && hi(oi, e, { configurable: !0, set: i }), mi(e, t);
        }).prototype,
        'toString',
        function () {
          return ci(this).tag;
    ...
    Kt(
      { target: 'Object', stat: !0, forced: !zt, sham: !m },
      {
        create: function (t, e) {
      ...
      Ri = function () {
        var t =
            arguments.length < 1 || void 0 === arguments[0]
              ? void 0
              : String(arguments[0]),
          e = this instanceof Ri ? new Qi(t) : void 0 === t ? Qi() : Qi(t);
        return '' === t && (xi[e] = !0), e;
      };
    Wt(Ri, Qi);
  ...
  var ln = function (t) {
    ...
    In = Array.prototype,
    gn = function (t) {
      return void 0 !== t && (ji.Array === t || In[an] === t);
    },
    dn = Mt('iterator'),
    bn = function (t) {
      if (null != t) return t[dn] || t['@@iterator'] || ji[xe(t)];
    },
    yn = Mt('iterator'),
    Bn = !1;
  try {
  ...
  var Hn = Mt('species'),
    ...
    Ln = function (t) {
      if (qi) {
        if (xn.call(Sn, t)) return t;
      } else
        for (var e in Wn)
          if (J(Wn, fn)) {
            var i = p[e];
            if (i && (t === i || xn.call(i, t))) return t;
          }
  ...
  var kn = Mt('unscopables'),
    Nn = Array.prototype;
  null == Nn[kn] && T.f(Nn, kn, { configurable: !0, value: Ne(null) });
  var En = function (t) {
      Nn[kn][t] = !0;
    },
    ...
    On = (function (t, e) {
      ...
      return (Kn[t] =
        ...
        !h(function () {
          if (n && !m) return !0;
          var t = { length: -1 };
          n ? Tn(t, 1, { enumerable: !0, get: zn }) : (t[1] = 1),
            i.call(t, c, o);
        }));
  ...
  var Pn = !h(function () {
      ...
      if (g) n = t;
        ...
        if (gn(c)) {
          for (o = 0, r = Zt(t.length); r > o; o++)
            if ((s = B(t[o])) && s instanceof Mn) return s;
          return new Mn(!1);
        }
        n = c.call(t);
      }
    ...
    oc =
      ((function (t, e, i) {
        ...
        if (
          ...
          (l = i.getConstructor(e, t, n, o)), (jn.REQUIRED = !0);
        else if (Et(t, !0)) {
          var I = new l(),
            g = I[o](c ? {} : -0, 1) != I,
            d = h(function () {
    ...
    lc = cn(
      ...
      'Array',
      function (t, e) {
        rc(this, { type: 'Array Iterator', target: Q(t), index: 0, kind: e });
      },
      function () {
        var t = sc(this),
          e = t.target,
      ...
      ? ((t._handled = !0),
        fc._immediateFn(function () {
          ...
          if (null !== i) {
            ...
            Zc(e.promise, n);
          } else (1 === t._state ? Zc : Uc)(e.promise, t._value);
        }))
      : t._deferreds.push(e);
  }
  function Zc(t, e) {
    try {
      ...
      if (e && ('object' == typeof e || 'function' == typeof e)) {
        var i = e.then;
        if (e instanceof fc) return (t._state = 3), (t._value = e), void Vc(t);
  ...
  (fc.prototype.catch = function (t) {
    ...
    (fc.all = function (t) {
      return new fc(function (e, i) {
        if (!hc(t)) return i(new TypeError('Promise.all accepts an array'));
        var n = Array.prototype.slice.call(t);
        if (0 === n.length) return e([]);
        var c = n.length;
        function o(t, r) {
    ...
    (fc.race = function (t) {
      return new fc(function (e, i) {
        if (!hc(t)) return i(new TypeError('Promise.race accepts an array'));
    ...
    _c = function (t, e, i, n, c, o) {
      return (
        ...
        g(void 0, void 0, void 0, function () {
          return d(this, function (r) {
            return c ? [2, Mc(t, e, i, n, o, c)] : [2, jc(t, n, o)];
          });
        })
      );
    };
  function qc(t, e, i, n, c, o) {
      ...
      return d(this, function (d) {
        switch (d.label) {
          ...
          case 1:
            ...
            d.label = 2;
          case 2:
            return d.trys.push([2, 4, , 5]), [4, _c(t, i, n, c, o, e)];
          case 3:
  ...
  var $c = function (t) {
    ...
    to = function () {
      ...
      return $c(t.join(' ').trim().split(/\s+/)).join(' ');
    };
  function eo(t, e) {
    var i = t.baseUrl,
      n = t.timeout,
      ...
      return (
        ...
        (t.fromKey = function (e) {
          ...
          return (
            ...
            new t({ client_id: c, scope: r, audience: o }, n)
          );
        }),
        t
      );
    ...
    ro = (function () {
      ...
      return (
        ...
        (t.prototype.readJson = function (t) {
          var e,
            i = oo(t, Object.keys(window.localStorage)),
    ...
    bo = {
      get: function (t) {
        if ('undefined' != typeof localStorage) {
          ...
          if (void 0 !== e)
            return console.log('localStorage ok, value = ', e), JSON.parse(e);
  ...
  var yo,
    ...
    fo = (function () {
      function t(t) {
        ...
        var n,
          c,
          o = t.useCookiesForTransactions ? this.cookieStorage : go;
        (this.cache = mo(this.cacheLocation)()),
          ...
          this.options.useRefreshTokens &&
            (this.scope = to(this.scope, 'offline_access')),
          'undefined' != typeof window &&
            window.Worker &&
            this.options.useRefreshTokens &&
      ...
      return (
        ...
        (t.prototype._getParams = function (t, e, i, n, c) {
          ...
          return a(a(a({}, r), t), {
            scope: to(this.defaultScope, this.scope, t.scope),
            response_type: 'code',
            response_mode: 'query',
            state: e,
            nonce: i,
            ...
            g(this, void 0, void 0, function () {
              ...
              return d(this, function (c) {
                return (
                  ...
                  (i = to(this.defaultScope, this.scope, t.scope)),
                  (n = this.cache.get(
                    new io({
                      client_id: this.options.client_id,
                      audience: e,
                  ...
                  console.log('getUser :', e, i, n, this.options.client_id),
              ...
              return d(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return (
                      (e = i.sent()),
                      console.log('loginWithRedirect; url', e),
                ...
                switch (i.label) {
                  case 0:
                    return (
                      ...
                      (t.scope = to(this.defaultScope, this.scope, t.scope)),
                      (e = a(a({}, xc), e)),
            ...
            return d(this, function (e) {
              switch (e.label) {
                ...
                case 1:
                  return (
                    (t = e.sent()),
                    console.log('spa isAuthenticated = ', !!t, t),
                    [2, !!t]
                  );
              }
            });
        ...
        (t.prototype._getTokenFromIFrame = function (t) {
          return g(this, void 0, void 0, function () {
            var e, i, n, c, o, r, s, l, u, g, b, y, B, C, p;
            return d(this, function (d) {
              switch (d.label) {
                case 0:
                  return (e = Tc(Ec())), (i = Tc(Ec())), (n = Ec()), [4, zc(n)];
                case 1:
                  (c = d.sent()),
                    (o = Oc(c)),
                    (r = this._getParams(
    ...
    Jo = function (t, e) {
      var i, n;
      switch ((console.log('reducer state = ', t, 'action = ', e), e.type)) {
        case 'LOGIN_POPUP_STARTED':
          return c(c({}, t), { isLoading: !0 });
        case 'LOGIN_POPUP_COMPLETE':
        case 'INITIALISED':
          return (
            console.log('reducer action = ', !!e.user, e),
            c(c({}, t), {
        ...
        case 'GET_ACCESS_TOKEN_COMPLETE':
          return (null === (i = t.user) || void 0 === i
            ? void 0
            : i.updated_at) ===
            (null === (n = e.user) || void 0 === n ? void 0 : n.updated_at)
            ? t
            : c(c({}, t), { isAuthenticated: !!e.user, user: e.user });
        case 'LOGOUT':
  ...
  (t.Auth0Context = Vo),
    (t.Auth0Provider = function (t) {
      ...
      var B = e.useCallback(
          function (t) {
            return g.buildAuthorizeUrl(Wo(t));
          },
          [g]
        ),
        C = e.useCallback(
          function (t) {
            return g.buildLogoutUrl(t);
          },
          [g]
        ),
        p = e.useCallback(
          function (t) {
            return g.loginWithRedirect(Wo(t));
          },
          [g]
        ),
        h = e.useCallback(
            ...
            return r(void 0, void 0, void 0, function () {
              ...
              return s(this, function (o) {
                switch (o.label) {
                  case 0:
                    return (
                      o.trys.push([0, 2, 3, 5]), [4, g.getTokenSilently(t)]
                    );
                  case 1:
                    return (e = o.sent()), [3, 5];
                  case 2:
            ...
            return r(void 0, void 0, void 0, function () {
              ...
              return s(this, function (r) {
                switch (r.label) {
                  case 0:
                    return (
                      r.trys.push([0, 2, 3, 5]), [4, g.getTokenWithPopup(t, e)]
                    );
                  case 1:
                    return (i = r.sent()), [3, 5];
                  case 2:

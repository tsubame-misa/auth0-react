!(function (t, e) {
  ...
  var dt,
    ...
    mt = Math.floor,
    ft = function (t) {
      return isNaN((t = +t)) ? 0 : (t > 0 ? mt : pt)(t);
    },
    Ft = Math.min,
    Zt = function (t) {
    ...
    wt = function (t, e) {
      var i = Yt[Lt(t)];
      return i == Nt || (i != kt && ('function' == typeof e ? p(e) : !!e));
    },
  ...
  var Ne =
    ...
    Bi = tt('wks'),
    Ci = h.QObject,
    hi = !Ci || !Ci.prototype || !Ci.prototype.findChild,
    pi =
      m &&
      p(function () {
        return (
    ...
    (zt ||
      (yt(
        (ri = function () {
          ...
          return m && hi && pi(oi, e, { configurable: !0, set: i }), mi(e, t);
        }).prototype,
        'toString',
        function () {
          return ci(this).tag;
  ...
  (fc.prototype.catch = function (t) {
    ...
    (fc.all = function (t) {
      return new fc(function (e, i) {
        if (!pc(t)) return i(new TypeError('Promise.all accepts an array'));
        var n = Array.prototype.slice.call(t);
        if (0 === n.length) return e([]);
        var c = n.length;
        function o(t, r) {
    ...
    (fc.race = function (t) {
      return new fc(function (e, i) {
        if (!pc(t)) return i(new TypeError('Promise.race accepts an array'));
    ...
    fo = (function () {
      ...
      return (
        ...
        (t.prototype._getTokenFromIFrame = function (t) {
          return g(this, void 0, void 0, function () {
            var e, i, n, c, o, r, s, l, u, g, b, y, B, C, h;
            return d(this, function (d) {
              switch (d.label) {
                case 0:

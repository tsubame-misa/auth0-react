...
var Auth0Provider = function (opts) {
  ...
  var client = useState(function () {
    return new Fr(toAuth0ClientOptions(clientOpts));
  })[0];
  ...
  var originalCallBack2 = useCallback(
    function (url) {
      return __awaiter(void 0, void 0, void 0, function () {
        var error_2, _a, _b;
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              console.log('url = ', url);
              url =
                'http://localhost:8100/?code=NwT6ZoRx26A447YS&state=SzQuLVA1ZGN2Rk94TVRrS01NTV9TTU5SNGtyUW8udERSblhfd3k2My5jTQ%3D%3D';
